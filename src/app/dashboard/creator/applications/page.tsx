...
import { ArrowLeft, MessageCircle, Upload, Clock, CheckCircle, XCircle, LogOut, FileText } from 'lucide-react';
      ...
      <div className="bg-white border-b border-gray-100 sticky top-0 z-10 shadow-sm">
        <div className="max-w-4xl mx-auto px-4 h-14 flex items-center gap-3">
          ...
          <span className="text-sm font-bold text-gray-900 flex-1">
            Mis aplicaciones {apps.length > 0 && <span className="text-gray-400">({apps.length})</span>}
          </span>
          <button
